...
# ----------------------------------------
# If my_sys_pcie_pio_av_mm_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.4 67 linux 2022.08.29.12:51:48
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "my_sys_pcie_pio_av_mm_0.my_sys_pcie_pio_av_mm_0"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/nfs/site/disks/swbld_archive_3/acds/21.4/67/linux64/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [my_sys_pcie_pio_av_mm_0::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [my_sys_pcie_pio_av_mm_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [my_sys_pcie_pio_av_mm_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [my_sys_pcie_pio_av_mm_0::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [my_sys_pcie_pio_av_mm_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [my_sys_pcie_pio_av_mm_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [my_sys_pcie_pio_av_mm_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
