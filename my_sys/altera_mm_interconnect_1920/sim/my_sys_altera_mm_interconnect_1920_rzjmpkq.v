// my_sys_altera_mm_interconnect_1920_rzjmpkq.v
...
`timescale 1 ps / 1 ps
module my_sys_altera_mm_interconnect_1920_rzjmpkq (
		...
		input  wire [3:0]  mm_master_bfm_0_m0_burstcount,                                   //                                                          .burstcount
	...
	wire    [5:0] mm_master_bfm_0_m0_translator_avalon_universal_master_0_burstcount;    // mm_master_bfm_0_m0_translator:uav_burstcount -> mm_master_bfm_0_m0_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                     // rsp_mux:src_valid -> mm_master_bfm_0_m0_agent:rp_valid
	wire  [118:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> mm_master_bfm_0_m0_agent:rp_data
	...
	wire  [118:0] mm_master_bfm_0_m0_agent_cp_data;                                      // mm_master_bfm_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [100:0] onchip_memory2_0_s1_agent_rp_data;                                     // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [100:0] onchip_memory2_0_s1_burst_adapter_source0_data;                        // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [100:0] router_001_src_data;                                                   // router_001:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [100:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                        // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	my_sys_altera_merlin_master_translator_191_g7h47bq #(
		.AV_ADDRESS_W                (32),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (4),
		.AV_BYTEENABLE_W             (4),
		...
		.uav_burstcount         (mm_master_bfm_0_m0_translator_avalon_universal_master_0_burstcount),    //  output,   width = 6,                          .burstcount
		...
		.av_burstcount          (mm_master_bfm_0_m0_burstcount),                                         //   input,   width = 4,                          .burstcount
	...
	my_sys_altera_merlin_master_agent_191_mpbm6tq #(
		.PKT_WUNIQUE               (118),
		.PKT_DOMAIN_H              (117),
		.PKT_DOMAIN_L              (116),
		.PKT_SNOOP_H               (115),
		...
		.av_burstcount         (mm_master_bfm_0_m0_translator_avalon_universal_master_0_burstcount),    //   input,    width = 6,          .burstcount
		...
		.cp_data               (mm_master_bfm_0_m0_agent_cp_data),                                      //  output,  width = 119,          .data
	...
	my_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                               //  output,  width = 101,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),                  //   input,  width = 101,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),                     //   input,  width = 102,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                        //  output,  width = 102,                .data
	...
	my_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),              //   input,  width = 102,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),           //  output,  width = 102,       out.data
	...
	my_sys_altera_merlin_router_1921_r4426cy router (
		...
		.sink_data          (mm_master_bfm_0_m0_agent_cp_data),                                //   input,  width = 119,          .data
	...
	my_sys_altera_merlin_router_1921_x6yg3sy router_001 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                               //   input,  width = 101,          .data
		...
		.src_data           (router_001_src_data),                                             //  output,  width = 101,          .data
		.src_channel        (router_001_src_channel),                                          //  output,    width = 1,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                                    //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                                       //  output,    width = 1,          .endofpacket
	);

	my_sys_altera_merlin_burst_adapter_1923_cxxxdcy #(
		.PKT_ADDR_H                (49),
		.PKT_ADDR_L                (18),
		.PKT_BEGIN_BURST           (75),
		.PKT_BYTE_CNT_H            (61),
		...
		.sink0_data            (onchip_memory2_0_s1_cmd_width_adapter_src_data),                  //   input,  width = 101,          .data
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),                  //  output,  width = 101,          .data
	...
	my_sys_altera_merlin_demultiplexer_1921_k4lsxky cmd_demux (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	my_sys_altera_merlin_multiplexer_1921_4saiw4i cmd_mux (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	my_sys_altera_merlin_demultiplexer_1921_k4lsxky rsp_demux (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (onchip_memory2_0_s1_rsp_width_adapter_src_data),                  //   input,  width = 119,          .data
	...
	my_sys_altera_merlin_multiplexer_1921_ejzlw6a rsp_mux (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	my_sys_altera_merlin_width_adapter_1920_a6ysr2a #(
		.IN_PKT_ADDR_H                 (49),
		.IN_PKT_ADDR_L                 (18),
		.IN_PKT_DATA_H                 (15),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_001_src_data),                                             //   input,  width = 101,          .data
		.out_endofpacket      (onchip_memory2_0_s1_rsp_width_adapter_src_endofpacket),           //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_memory2_0_s1_rsp_width_adapter_src_data),                  //  output,  width = 119,          .data
	...
	my_sys_altera_merlin_width_adapter_1920_6q4fpqq #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.out_data             (onchip_memory2_0_s1_cmd_width_adapter_src_data),                  //  output,  width = 101,          .data
