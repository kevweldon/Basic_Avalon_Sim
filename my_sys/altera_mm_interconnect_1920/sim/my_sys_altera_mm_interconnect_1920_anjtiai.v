// my_sys_altera_mm_interconnect_1920_anjtiai.v
...
`timescale 1 ps / 1 ps
module my_sys_altera_mm_interconnect_1920_anjtiai (
	...
	wire  [126:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> mm_master_bfm_0_m0_agent:rp_data
	...
	wire  [126:0] mm_master_bfm_0_m0_agent_cp_data;                                      // mm_master_bfm_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [126:0] onchip_memory2_0_s1_agent_rp_data;                                     // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	my_sys_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (mm_master_bfm_0_m0_agent_cp_data),                                      //  output,  width = 127,          .data
	...
	my_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                               //  output,  width = 127,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),                  //   input,  width = 127,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),                     //   input,  width = 128,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                        //  output,  width = 128,                .data
	...
	my_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),              //   input,  width = 128,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),           //  output,  width = 128,       out.data
	...
	my_sys_altera_merlin_router_1921_go6fhha router (
		...
		.sink_data          (mm_master_bfm_0_m0_agent_cp_data),                                //   input,  width = 127,          .data
	...
	my_sys_altera_merlin_router_1921_pyad5ji router_001 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                               //   input,  width = 127,          .data
	...
	my_sys_altera_merlin_burst_adapter_1923_g6aiebi #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (101),
		.PKT_BYTE_CNT_H            (83),
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),                  //  output,  width = 127,          .data
	...
	my_sys_altera_merlin_demultiplexer_1921_4bpriii cmd_demux (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	my_sys_altera_merlin_multiplexer_1921_qz7nzsi cmd_mux (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	my_sys_altera_merlin_demultiplexer_1921_4bpriii rsp_demux (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	my_sys_altera_merlin_multiplexer_1921_bzawx5y rsp_mux (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_master_bfm_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
