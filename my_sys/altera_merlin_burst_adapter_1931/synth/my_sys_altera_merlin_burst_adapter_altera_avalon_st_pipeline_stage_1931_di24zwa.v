// my_sys_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1931_di24zwa.v

// Generated using ACDS version 23.4 79

`timescale 1 ps / 1 ps
module my_sys_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1931_di24zwa #(
	...
	my_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 140,          .data
		...
		.out_data          (out_data),          //  output,  width = 140,          .data
