...
add wave -noupdate -expand -group AVMM_BFM /top_tb/dut/mm_master_bfm_0/avm_burstcount
...
add wave -noupdate -expand -group AVMM_BFM /top_tb/dut/mm_master_bfm_0/avm_waitrequest
...
add wave -noupdate -expand -group AVMM_BFM /top_tb/dut/mm_master_bfm_0/avm_readdatavalid
add wave -noupdate -expand -group onchip_ram /top_tb/dut/onchip_memory2_0/clk
add wave -noupdate -expand -group onchip_ram /top_tb/dut/onchip_memory2_0/address
...
add wave -noupdate -expand -group onchip_ram /top_tb/dut/onchip_memory2_0/readdata
...
WaveRestoreCursors {{Cursor 1} {639352 ps} 0}
...
update
WaveRestoreZoom {210736 ps} {394429 ps}
